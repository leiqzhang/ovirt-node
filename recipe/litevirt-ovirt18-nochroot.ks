...
sed -i -e "s/label Reinstall/label Reinstall ${PRODUCT_SHORT}/" $LIVE_ROOT/isolinux/isolinux.cfg
sed -i -e "s/label Uninstall/label Uninstall ${PRODUCT_SHORT}/" $LIVE_ROOT/isolinux/isolinux.cfg
